...
export default function Toast({ msg, onClose }) {
  ...
  return (
    <div style={{position:"fixed",top:64,right:20,zIndex:9999,minWidth:268,background:c.bg,border:`1px solid ${c.border}`,borderRadius:D.radiusBtn,padding:"11px 16px",boxShadow:D.s2,display:"flex",alignItems:"center",gap:10,animation:"tsIn .18s ease"}}>
