...
export default function Toast({ msg, onClose }) {
  ...
  return (
    <div style={{position:"fixed",top:28,right:28,zIndex:9999,minWidth:280,background:c.bg,border:`1px solid ${c.border}`,borderRadius:18,padding:"12px 16px",boxShadow:D.s2,display:"flex",alignItems:"center",gap:10,animation:"tsIn .18s ease"}}>
